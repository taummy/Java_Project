...
public class SecondView extends javax.swing.JFrame {
    ...
    //we create objects from all the other classes because we'll need them
...
//We have to also prepare the thirdview
    private void view2nextbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view2nextbuttonActionPerformed
        ...
        thirdview.logType=selectedLog;//We need the logTYpe for the switch statement in the third view
        //We create the txt file of the selected log via this method
        l.createLogsFiles(selectedLog);
        
        
        /*
        THIS SWITCH STATEMENT
        depending on the case, we customize a combobox model for the scroller in the third view
        Then we customize the table in the thirdview
        */
        switch(selectedLog){
            case "exemple.apache2.access.log":
                ...
                apache.apacheProcess(selectedLog+".txt");//we call the method to process the selected log
